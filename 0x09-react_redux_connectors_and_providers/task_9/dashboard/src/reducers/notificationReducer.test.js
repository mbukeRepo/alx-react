...
/**  it("Tests that MARK_AS_READ returns the data with the right item updated", function () {
    ...
    initialState.messages = notificationsNormalizer(
    ...
    expectedData.messages[1].isRead = false;
    expectedData.messages[2].isRead = true;
    expectedData.messages[3].isRead = false;
