...
class Notifications extends Component {
  ...
  onMouseLeave = () => {this.setState({displayDrawer: true})}
  onClick = () => {this.props.setDisplay()};

  render() {
    const { listNotifications, displayDrawer, setDisplay } = this.props;

    const show = css(displayDrawer ? styles.showOff : styles.showOn);
    
    return (
      <Fragment>
        <div className={css(styles.menuItem)} onClick = {setDisplay}>
